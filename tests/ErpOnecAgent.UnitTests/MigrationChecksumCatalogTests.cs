...
public sealed class MigrationChecksumCatalogTests
{
    ...
    private const string V11Published = "6ABF179B5A13EE6928B72116099BCC9402584BE82062D107DE10B28B77BE2BEA";
    ...
    public void Cataloged_resource_variants_resolve_to_canonical_published_checksum()
    {
        ...
        Assert.Equal(V11Published, MigrationChecksumCatalog.ResolveRecordedChecksum(11, "011_watermark_domain_resets.sql", V11Published));
    }
    ...
    public void Catalog_checksums_match_shipped_embedded_migration_resources()
    {
        ...
        // 001-011 must be cataloged and approved.
