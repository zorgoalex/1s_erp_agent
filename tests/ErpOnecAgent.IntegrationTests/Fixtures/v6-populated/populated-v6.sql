-- v6-populated fixture: immutable pre-007 database state, exactly 001_initial.sql +
-- 002_retry_budgets.sql + 003_ordering_claims.sql + 004_command_payload_conflicts.sql +
-- 005_durable_etl_jobs.sql + 006_etl_finalize.sql semantics (a real v6 database).
-- Applied on top of 001-006 (schema) + the correct v1-v6 schema_migrations ledger rows.
-- Exercises that 007_etl_ownership is purely additive: every command, attempt, outbox,
-- ETL job, run/entity/batch, watermark, state, snapshot and conflict row is preserved
-- byte-for-byte, the ownership tables start empty, and the new etl_jobs/etl_runs
-- columns get their documented NULL/zero defaults.
--
...
-- v6 runs in every lifecycle position, including a sealed 'uploading' run and a
-- 'completing' run holding a completion claim — the new-path states 007 must preserve.
...
VALUES
('00000000-0000-0000-0000-0000000000e1','incremental','["clients"]','running','2026-09-19T10:00:00.0000000+00:00',NULL,10,1,0,0,NULL,NULL,'2026-09-19T10:00:00.0000000+00:00','2026-09-19T10:00:00.0000000+00:00',1,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('00000000-0000-0000-0000-0000000000e2','bootstrap_full','["clients","orders"]','uploading','2026-09-18T08:00:00.0000000+00:00',NULL,42,1,1,0,NULL,NULL,'2026-09-18T08:00:00.0000000+00:00','2026-09-18T08:00:00.0000000+00:00',1,'2026-09-18T08:05:00.0000000+00:00',1,1,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('00000000-0000-0000-0000-0000000000e3','incremental','["clients"]','succeeded','2026-09-11T06:00:00.0000000+00:00','2026-09-11T06:10:00.0000000+00:00',7,1,1,0,NULL,NULL,'2026-09-11T06:00:00.0000000+00:00','2026-09-11T06:10:00.0000000+00:00',1,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('00000000-0000-0000-0000-0000000000e4','bootstrap_full','["clients"]','pending',NULL,NULL,0,0,0,0,NULL,3,'2026-09-20T07:00:00.0000000+00:00','2026-09-20T07:00:00.0000000+00:00',1,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('00000000-0000-0000-0000-0000000000e5','bootstrap_full','["orders"]','completing','2026-09-19T09:00:00.0000000+00:00',NULL,7,1,1,0,NULL,3,'2026-09-19T09:00:00.0000000+00:00','2026-09-19T09:10:00.0000000+00:00',3,'2026-09-19T09:05:00.0000000+00:00',1,1,'00000000-0000-0000-0000-000000000cc1','owner-7','2026-09-19T09:09:00.0000000+00:00',1,8,'2026-09-19T09:20:00.0000000+00:00','{"runId":"00000000-0000-0000-0000-0000000000e5","status":"succeeded","rowsRead":7,"batchesCreated":1,"batchesAcknowledged":1,"completedAtUtc":"2026-09-19T09:09:00.0000000+00:00"}',NULL,NULL,NULL,NULL);
...
VALUES
('00000000-0000-0000-0000-0000000000e2','clients','{"entityCode":"clients"}','fp-e2-clients','done',1,4,'{"updatedAtUtc":"2026-09-17T05:59:00.0000000+00:00","sourceId":"A4"}','fp-e2-clients','same','{"updatedAtUtc":"2026-09-17T05:59:00.0000000+00:00","sourceId":"A4"}',NULL,'{"updatedAtUtc":"2026-09-18T07:59:00.0000000+00:00","sourceId":"A42"}',1,42,1,NULL,'2026-09-18T08:00:00.0000000+00:00','2026-09-18T08:05:00.0000000+00:00',1),
('00000000-0000-0000-0000-0000000000e5','orders','{"entityCode":"orders"}','fp-e5-orders','done',0,NULL,NULL,NULL,'absent',NULL,NULL,'{"updatedAtUtc":"2026-09-19T08:59:00.0000000+00:00","sourceId":"O7"}',1,7,1,NULL,'2026-09-19T09:00:00.0000000+00:00','2026-09-19T09:05:00.0000000+00:00',1);
...
-- One accepted durable job (pending) over run e4 plus one already-finished job.
...
('00000000-0000-0000-0000-000000000a02','00000000-0000-0000-0000-000000000606','00000000-0000-0000-0000-0000000000e3','entity_reload','[{"entityCode":"clients","oDataPath":"Catalog_Clients","keyField":"Ref_Key","updatedAtField":"UpdatedAt","deletedField":"DeletionMark","select":["Ref_Key","UpdatedAt","DeletionMark"],"syncMode":"incremental","pageSize":500,"overlapMinutes":10,"schemaVersion":1,"oDataVersion":3,"enabled":true,"keyFields":null,"updatedAtEdmType":"Edm.DateTimeOffset"}]',2,'finished','hash-j606','{"commandId":"00000000-0000-0000-0000-000000000606","status":"succeeded","completedAtUtc":"2026-09-11T06:00:00.0000000+00:00","data":{"accepted":true,"runId":"00000000-0000-0000-0000-0000000000e3","mode":"entity_reload"},"warnings":[],"resultVersion":1}','2026-09-11T06:00:00.0000000+00:00','2026-09-11T06:10:00.0000000+00:00',2);
