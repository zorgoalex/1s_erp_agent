-- v10-populated fixture: immutable pre-011 database state, exactly 001_initial.sql +
...
-- 008_etl_send_attempts.sql + 009_etl_scheduled_runs.sql + 010_etl_run_resolutions.sql
-- semantics (a real v10 database). Applied on top of 001-010 (schema) + the correct
-- v1-v10 schema_migrations ledger rows seeded by the test (ledger entries are NOT in
-- this file).
-- Builds on the v9 fixture (every v9 row kept byte-identical except run f6, which is
-- now RESOLVED — resolved_at_utc set, its 'assets' ownership released
-- 'manual_release', and one immutable etl_run_resolutions row attesting it),
-- extended with the D1-upgrade-critical watermark states:
--   * 'clients'       — a committed row with a domain fingerprint (generation 3);
--   * 'legacy_products' — a legacy row with a NULL domain_fingerprint (unknown domain);
--   * 'currencies'    — a committed row at a HIGH generation (9007).
-- 011 must stay additive: every pre-existing row survives byte-identical and
-- watermark_domain_resets is created EMPTY.
...
--   j909 reload_entity    result_pending  accepted job a06 (resolved blocked run f6)
...
-- Runs: the v9 lifecycle coverage plus the resolution marker on f6:
...
--   f6 manual 'blocked'        RESOLVED (resolved_at_utc set), job a06 blocked,
--                              ownership released 'manual_release'
...
('00000000-0000-0000-0000-0000000000f6','entity_reload','["assets"]','blocked','2026-09-21T09:10:00.0000000+00:00','2026-09-21T09:40:00.0000000+00:00',22,1,0,1,'A batch send outcome was unknowable.',3,'2026-09-21T09:00:00.0000000+00:00','2026-09-22T10:00:00.0000000+00:00',4,'2026-09-21T09:20:00.0000000+00:00',1,1,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'UPLOAD_OUTCOME_UNKNOWN','send outcome unknown for batch 00000000-0000-0000-0000-000000000b10','2026-09-22T10:00:00.0000000+00:00',NULL,NULL,NULL,NULL,NULL);
...
-- and a dead_letter UPLOAD_OUTCOME_UNKNOWN batch of the resolved blocked run.
...
-- Durable jobs: the v8 set plus the blocked jobs of the failed f5 and the RESOLVED
-- blocked f6 runs (terminate blocks the job, resolution never finishes it).
...
('00000000-0000-0000-0000-000000000a06','00000000-0000-0000-0000-000000000909','00000000-0000-0000-0000-0000000000f6','entity_reload','[{"entityCode":"assets","oDataPath":"Catalog_FixedAssets","keyField":"Ref_Key","updatedAtField":"Date","deletedField":"Posted","select":["Ref_Key","Date","Posted"],"syncMode":"incremental","pageSize":500,"overlapMinutes":10,"schemaVersion":1,"oDataVersion":3,"enabled":true,"keyFields":null,"updatedAtEdmType":"Edm.DateTimeOffset"}]',3,'blocked','hash-j909','{"commandId":"00000000-0000-0000-0000-000000000909","status":"succeeded","completedAtUtc":"2026-09-21T09:00:02.0000000+00:00","data":{"accepted":true,"runId":"00000000-0000-0000-0000-0000000000f6","mode":"entity_reload"},"warnings":[],"resultVersion":1}','2026-09-21T09:00:00.0000000+00:00','2026-09-22T10:00:00.0000000+00:00',4,'dispatcher-2','2026-09-21T09:10:00.0000000+00:00',1,NULL,NULL,NULL);

-- The attested resolution (010) of blocked run f6: one immutable record —
-- 'abandon', quiesced, prior 'blocked' with its conflict code; 1 ownership row
-- released ('assets'), no batches fenced (its only batch was already dead_letter).
...
VALUES
('00000000-0000-0000-0000-0000000000f6','00000000-0000-0000-0000-000000000e01','2026-09-22T10:00:00.0000000+00:00','operator-1','abandon','ERP staging reconciled: no rows landed for the unknowable send',1,'blocked','UPLOAD_OUTCOME_UNKNOWN',1,0);
...
-- owner_job_id NULL), 'currencies' released by succeeded f4 ('finalized'),
-- 'employees' retained by the failed f5, and 'assets' released by the RESOLVED f6
-- ('manual_release').
...
('assets','00000000-0000-0000-0000-0000000000f6','00000000-0000-0000-0000-000000000a06',1,'2026-09-21T09:10:00.0000000+00:00','2026-09-22T10:00:00.0000000+00:00','manual_release','2026-09-22T10:00:00.0000000+00:00',2);
...
-- The D1 reset domain surface: a fingerprinted row, a legacy NULL-fingerprint row
-- (unknown domain — resettable only via the attested path), and a high-generation row.
...
('legacy_products','{"updatedAtUtc":"2026-09-10T05:59:00.0000000+00:00","sourceId":"L2"}',NULL,'00000000-0000-0000-0000-0000000000e3','2026-09-10T06:10:00.0000000+00:00',5,NULL),
('currencies','{"updatedAtUtc":"2026-09-21T02:59:00.0000000+00:00","sourceId":"C9"}',NULL,'00000000-0000-0000-0000-0000000000f4','2026-09-21T03:10:00.0000000+00:00',9007,'fp-f4-currencies');
