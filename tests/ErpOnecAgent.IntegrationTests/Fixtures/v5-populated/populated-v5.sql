-- v5-populated fixture: immutable pre-006 database state, exactly 001_initial.sql +
-- 002_retry_budgets.sql + 003_ordering_claims.sql + 004_command_payload_conflicts.sql +
-- 005_durable_etl_jobs.sql semantics (a real v5 database). Applied on top of 001-005
-- (schema) + the correct v1-v5 schema_migrations ledger rows. Exercises that
-- 006_etl_finalize is purely additive: every command, attempt, outbox, ETL job,
-- run/batch, watermark, state, snapshot and conflict row is preserved byte-for-byte,
-- and the new watermarks/etl_runs columns get their documented defaults.
--
...
-- v5 runs in every lifecycle position the finalize slice must not touch, including a
-- pending run owned by an accepted durable job.
INSERT INTO etl_runs(run_id,mode,requested_entities_json,status,started_at_utc,finished_at_utc,rows_read,batches_created,batches_acknowledged,error_count,last_error,configuration_version,created_at_utc,updated_at_utc,row_version)
VALUES
('00000000-0000-0000-0000-0000000000e1','incremental','["clients"]','running','2026-09-19T10:00:00.0000000+00:00',NULL,10,1,0,0,NULL,NULL,'2026-09-19T10:00:00.0000000+00:00','2026-09-19T10:00:00.0000000+00:00',1),
('00000000-0000-0000-0000-0000000000e2','bootstrap_full','["clients","orders"]','uploading','2026-09-18T08:00:00.0000000+00:00',NULL,42,1,1,0,NULL,NULL,'2026-09-18T08:00:00.0000000+00:00','2026-09-18T08:00:00.0000000+00:00',1),
('00000000-0000-0000-0000-0000000000e3','incremental','["clients"]','succeeded','2026-09-11T06:00:00.0000000+00:00','2026-09-11T06:10:00.0000000+00:00',7,1,1,0,NULL,NULL,'2026-09-11T06:00:00.0000000+00:00','2026-09-11T06:10:00.0000000+00:00',1),
('00000000-0000-0000-0000-0000000000e4','bootstrap_full','["clients"]','pending',NULL,NULL,0,0,0,0,NULL,3,'2026-09-20T07:00:00.0000000+00:00','2026-09-20T07:00:00.0000000+00:00',1);
