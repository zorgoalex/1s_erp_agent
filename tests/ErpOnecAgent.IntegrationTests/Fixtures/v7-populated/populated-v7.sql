-- v7-populated fixture: immutable pre-008 database state, exactly 001_initial.sql +
-- 002_retry_budgets.sql + 003_ordering_claims.sql + 004_command_payload_conflicts.sql +
-- 005_durable_etl_jobs.sql + 006_etl_finalize.sql + 007_etl_ownership.sql semantics
-- (a real v7 database). Applied on top of 001-007 (schema) + the correct v1-v7
-- schema_migrations ledger rows seeded by the test (ledger entries are NOT in this file).
-- Builds on the v6 fixture coverage, extended with the O2-upgrade-critical states:
--   * an in-flight legacy 'uploading' batch of a sealed 'uploading' run — a send whose
--     remote outcome is unknowable across the upgrade;
...
--   * a 'running' run holding its extraction claim fence;
--   * released ownership left by a finalized run;
--   * every command state, attempt/outbox rows, jobs, watermarks, snapshots, conflicts.
--
-- 008 must stay additive: every pre-existing row survives byte-identical, the ledger
-- table arrives empty, and the new etl_batches columns take their declared defaults
-- (send_attempt_id NULL, upload_max_attempts NULL, quarantine_code NULL, row_version 1).
...
-- Batches: an acknowledged pair for the succeeded/completing runs, a ready batch of
-- the still-extracting run, AN IN-FLIGHT LEGACY 'uploading' batch of the sealed run
-- (a send whose remote outcome is unknowable), and a dead_letter batch of the
-- blocked run.
...
VALUES
('00000000-0000-0000-0000-000000000b01','00000000-0000-0000-0000-0000000000e1','payments',1,'spool/e1-b1.gz','ready',10,NULL,'{"updatedAtUtc":"2026-09-19T09:59:00.0000000+00:00","sourceId":"P10"}','hash-e1b1',1000,5000,0,'2026-09-19T10:00:01.0000000+00:00','2026-09-19T10:00:01.0000000+00:00',NULL,NULL),
...
('00000000-0000-0000-0000-000000000b03','00000000-0000-0000-0000-0000000000e3','products',1,'spool/e3-b1.gz','acknowledged',7,NULL,'{"updatedAtUtc":"2026-09-11T05:59:00.0000000+00:00","sourceId":"A7"}','hash-e3b1',900,4000,1,'2026-09-11T06:00:01.0000000+00:00','2026-09-11T06:00:01.0000000+00:00','2026-09-11T06:01:00.0000000+00:00',NULL),
...
('00000000-0000-0000-0000-000000000b06','00000000-0000-0000-0000-0000000000e2','clients',1,'spool/e2-b2.gz','uploading',30,NULL,'{"updatedAtUtc":"2026-09-18T07:59:00.0000000+00:00","sourceId":"A43"}','hash-e2b2',1500,7000,1,NULL,'2026-09-18T08:02:00.0000000+00:00',NULL,NULL),
('00000000-0000-0000-0000-000000000b07','00000000-0000-0000-0000-0000000000e6','inventory',1,'spool/e6-b1.gz','dead_letter',60,NULL,'{"updatedAtUtc":"2026-09-18T10:59:00.0000000+00:00","sourceId":"I9"}','hash-e6b1',3000,12000,0,NULL,'2026-09-18T11:05:00.0000000+00:00',NULL,'RUN_BLOCKED');
