...
public sealed class EtlFinalizeMigrationTests : IAsyncLifetime
{
    ...
    {
        _migrationSql = new string[6];
        string[] names = ["001_initial.sql", "002_retry_budgets.sql", "003_ordering_claims.sql", "004_command_payload_conflicts.sql", "005_durable_etl_jobs.sql", "006_etl_finalize.sql"];
